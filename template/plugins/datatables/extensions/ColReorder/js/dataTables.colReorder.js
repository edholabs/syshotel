...
var ColReorder = function( dt, opts )
{
	 ...
	 */
	this.s = {
templates		 * DataTables settings object
		 *  @property dt
		 *  @type     Object
		 *  @default  null
		 */
...
templates		 * Initialisation object used for this instance
		 *  @property init
		 *  @type     object
		 *  @default  {}
		 */
...
templates		 * Number of columns to fix (not allow to be reordered)
		 *  @property fixed
		 *  @type     int
		 *  @default  0
		 */
...
templates		 * Number of columns to fix counting from right (not allow to be reordered)
		 *  @property fixedRight
		 *  @type     int
		 *  @default  0
		 */
...
templates		 * Callback function for once the reorder has been done
...
templates		 * @namespace Information used for the mouse drag
		 */
		"mouse": {
			"startX": -1,
			"startY": -1,
...
templates		 * Information which is used for positioning the insert cusor and knowing where to do the
	 ...
	 */
	this.dom = {
templates		 * Dragging element (the one the mouse is moving)
		 *  @property drag
		 *  @type     element
		 *  @default  null
		 */
...
ColReorder.prototype = {
	 ...
	 *    var order = $.fn.dataTable.ColReorder( dataTable ).fnOrder();
	 templates	 * Set the order of the columns, from the positions identified in the
