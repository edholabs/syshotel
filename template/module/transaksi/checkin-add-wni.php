...
include('component/com-transaksi-wni.php');

$nomor_invoice='INV-'.date('Ymd').'-'.(rand(1,1000));
				...
				<div class="row">
					<div class="col-sm-3">
						...
						<div class="form-group">
							...
							<select class="form-control nama_tamu" name="id_tamu_wni">
								<option selected="selected">Daftar Tamu Indonsia</option>
					...
					<div class="col-sm-5">
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<input class="form-control" name="tanggal_checkin" value="<?php echo date('d-m-Y'); ?>" readonly />
								</div>
								<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<input id="checkout" class="form-control" name="tanggal_checkout" data-date-format="dd-mm-yyyy" />
								</div>
								<div class="col-sm-6">
